          ...
          <div className="company_headerDivOne">
            ...
            <div className="demontajDiv">
              ...
              <p className="pDemontaj">
                ...
                Колебания стоимости незначительные. Вы сможете сдать автомобиль
                на металлолом по выгодной цене. У нас удобный график работы,
                прием заявок – ежедневно с 8:00 до 17:00, обед с 12:00 до 13:00.
                Можно связаться с нами по специальной форме на сайте и уточнить,
                как сдать машину на металл. Отвечаем оперативно.
              </p>
            </div>
          </div>
